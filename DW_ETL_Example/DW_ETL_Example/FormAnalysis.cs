...
namespace DW_ETL_Example
{
    public partial class FormAnalysis : Form
    {
        ...
        private void btnReport3_Click(object sender, EventArgs e)
        {
            try
            {
                string cmdText = "CALL PopularSizeFilter('" + cbReport3.SelectedIndex + "','" + tbOrigin1.Text + "');";
                ...
                chart1.DataSource = dt;
                chart1.Series[0].Name = "Total Sold Size";
                switch (cbReport3.SelectedIndex)
                {
                    case 0:
                        chart1.Series[0].XValueMember = "size";
                        chart1.Series[0].YValueMembers = "SizeFreq";
                        break;
                    case 1:
                        chart1.Series[0].XValueMember = "size";
                        chart1.Series[0].YValueMembers = "SizeFreq";
        ...
        private void btnReport4_Click(object sender, EventArgs e)
        {
            try
            {
                string cmdText = "CALL pSoldBrandsFilter('" + cbReport4.SelectedIndex + "');";
                ...
                chart1.DataSource = dt;
                chart1.Series[0].Name = "Total Brand Sold";
